                  ...
                  <?php foreach( $items as $id => $details ):
                    ...
                    ?>
                      ...
                      <table>
                        ...
                        <tbody>
                          <?php foreach( $details->items as $key => $i ):
                            $html_id = "client-" . $index . "-" . $key;
                            ?>
                            <tr class="<?= $i->get_is_invoiced() ? "non-selectable" : "";?>"><td><input
                                type="checkbox"
                                ...
                                autocomplete="off"
                                id="<?= htmlspecialchars($html_id);?>"
                                ></td><td><label for="<?= htmlspecialchars($html_id);?>">
                                  -
                              ...
                              <td class="non-selectable"><?= $i->get_is_billable() ? "Yes" : "No";?></td>
                              <td class="non-selectable"><?= round( array_reduce( $i->time_entries, function( $a, $b ){ return $a + $b->seconds; }, 0 ) / 60 / 60, 2);?></td>
                            </tr>
                          <?php endforeach;?>
                        </tbody>
                      </table>
